...
**位置**: `E:\GitCortex\crates\db\src\models\terminal.rs:471-488`
...
**位置**: `E:\GitCortex\crates\services\src\services\orchestrator\terminal_coordinator.rs:79`
```rust
...
**位置**: `E:\GitCortex\crates\services\src\services\terminal\launcher.rs:346-392`
```rust
...
**位置**: `E:\GitCortex\crates\db\src\models\terminal.rs:381-395`
...
**前端订阅代码**: `E:\GitCortex\frontend\src\stores\wsStore.ts:404-408`
```typescript
...
**位置**: `E:\GitCortex\crates\server\src\routes\workflows.rs:668-724`
...
- 本次通过多名前端/后端/全栈子代理并行审计 `E:\GitCortex` 全量代码，重点核查 `phase24/phase25` 的“待确认信息传递到主 Agent 终端”链路。
