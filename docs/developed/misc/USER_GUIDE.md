...
GitCortex 是一个智能代码编排平台，通过工作流自动化管理多个 AI 编码代理，实现复杂开发任务的并行执行和协调。
...
**重要**: `GITCORTEX_ENCRYPTION_KEY` 必须是 32 字符的字符串，用于加密 API 密钥。
...
**A**: 确保 `GITCORTEX_ENCRYPTION_KEY` 环境变量已设置且为 32 字符。
...
- **文档**: https://docs.gitcortex.io
- **问题反馈**: https://github.com/your-org/gitcortex/issues
- **社区讨论**: https://discord.gg/gitcortex
