...
在对 `docs/archive/pending/plans/2026-01-16-orchestrator-design.md` 设计文档与前端实现进行全面对比审计后，发现 **48 个偏差**，涵盖：
...
- 设计文档: `docs/archive/pending/plans/2026-01-16-orchestrator-design.md`
